...
--
-- Name: parties; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE "public"."parties" (
    "id" bigint NOT NULL,
    "name" "text",
    "pin" "text" DEFAULT 'substr((uuid_generate_v4())::text, 0, 7)'::"text" NOT NULL,
...
--
-- Name: TABLE "parties"; Type: COMMENT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties_with_names; Type: VIEW; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE "public"."parties_with_names" OWNER TO "supabase_admin";

--
-- Name: std_form; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE "public"."std_form" OWNER TO "supabase_admin";

--
-- Name: TABLE "std_form"; Type: COMMENT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: std_form_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties parties_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties parties_token_key; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: std_form std_form_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: guests guests_member_of_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties Allow Sam access; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: parties; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE "public"."parties" ENABLE ROW LEVEL SECURITY;

--
-- Name: std_form; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: TABLE "parties"; Type: ACL; Schema: public; Owner: supabase_admin
--
...
--
-- Name: SEQUENCE "parties_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE "public"."parties_id_seq" TO "postgres";
...
--
-- Name: TABLE "parties_with_names"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."parties_with_names" TO "postgres";
...
--
-- Name: TABLE "std_form"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."std_form" TO "postgres";
...
--
-- Name: SEQUENCE "std_form_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE "public"."std_form_id_seq" TO "postgres";
